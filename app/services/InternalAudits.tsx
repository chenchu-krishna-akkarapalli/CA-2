...
const InternalAudits = () => {
  const pageData = {
    ...
    description: `Comprehensive assistance for Internal and Concurrent Audits. We ensure full compliance with all regulations and provide strategic advice to optimize your business operations. Our team of experts handles every aspect with precision and care.`,

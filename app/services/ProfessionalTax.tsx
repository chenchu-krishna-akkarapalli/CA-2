...
The maximum professional tax payable is capped at â‚¹2,500 per year. While the tax amount is small, non-compliance attracts heavy penalties. Professional Tax registration is essential for obtaining other registrations and for maintaining good standing with state authorities.`,
    ...
    keyHighlights: [
      ...
      { title: "Maximum â‚¹2,500", desc: "Constitutional cap on annual professional tax", icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
    ...
    faqs: [
      ...
      { q: "What are the penalties for non-compliance?", a: "Late payment attracts interest (1-2% per month). Penalty for not registering can be â‚¹5,000 or more. Continued non-compliance may lead to prosecution." },
      { q: "Is Professional Tax applicable to all employees?", a: "PT is applicable based on salary slabs defined by each state. Generally, employees earning below â‚¹10,000-15,000 monthly may be exempt depending on state rules." }
    ],

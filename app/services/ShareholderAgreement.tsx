...
const ShareholderAgreement = () => {
  const pageData = {
    serviceName: "Shareholder Agreement",
    heroImage: "/hero-img/hero-2.png",
    heroTitle: "Shareholder Agreement",
    heroSubtitle: "Professional services for Shareholder Agreement. Expert guidance and compliance support.",
    
    description: `Comprehensive assistance for Shareholder Agreement. We ensure full compliance with all regulations and provide strategic advice to optimize your business operations. Our team of experts handles every aspect with precision and care.`,

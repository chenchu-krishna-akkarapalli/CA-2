...
Trademark registration is valid for 10 years and can be renewed indefinitely. The Â® symbol can only be used after registration, while â„¢ can be used for unregistered marks. We handle the complete process from trademark search to registration certificate.`,
    ...
    keyHighlights: [
      ...
      { title: "Use Â® Symbol", desc: "Official registered trademark symbol usage", icon: "M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" },
    ...
    faqs: [
      ...
      { q: "How long does trademark registration take?", a: "If no objection, registration takes 12-18 months. You get application number immediately and can use â„¢ symbol. If objections arise, it may take longer." },
      { q: "What is the difference between â„¢ and Â®?", a: "â„¢ can be used for unregistered trademarks to claim common law rights. Â® can only be used after official registration is granted." },

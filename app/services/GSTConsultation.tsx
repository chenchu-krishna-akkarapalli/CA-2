...
const GSTConsultation = () => {
  const pageData = {
    serviceName: "GST Consultation",
    heroImage: "/hero-img/hero-2.png",
    heroTitle: "GST Consultation",
    heroSubtitle: "Professional services for GST Consultation. Expert guidance and compliance support.",
    
    description: `Comprehensive assistance for GST Consultation. We ensure full compliance with all regulations and provide strategic advice to optimize your business operations. Our team of experts handles every aspect with precision and care.`,
...
export default GSTConsultation;

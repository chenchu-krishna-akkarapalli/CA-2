...
const BankLoans = () => {
  const pageData = {
    serviceName: "Loans from Banks and NBFCs",
    heroImage: "/hero-img/hero-2.avif",
    heroTitle: "Loans from Banks and NBFCs",
    heroSubtitle: "Professional services for Loans from Banks and NBFCs. Expert guidance and compliance support.",
    
    description: `Comprehensive assistance for Loans from Banks and NBFCs. We ensure full compliance with all regulations and provide strategic advice to optimize your business operations. Our team of experts handles every aspect with precision and care.`,

...
const ValueIcons = [Users, BarChart3, Workflow, Headphones];
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-[10px] mb-10 sm:mb-12">
        ...
        <div className="h-[6px] w-[220px] sm:w-[300px] lg:w-[352px] rounded-full bg-gradient-to-b from-brand-primary to-brand-accent" />

        <div className="mt-6 flex items-center justify-center gap-3">
          <Target className="w-[40px] h-[40px] sm:w-[50px] sm:h-[50px] text-brand-accent" strokeWidth={1.5} />

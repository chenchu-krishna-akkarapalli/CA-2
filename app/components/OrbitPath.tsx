// Adapted from Dominik Koch — https://x.com/dominikkoch
// Source: https://reactbits.dev/animations/orbit-images
// Changes: framer-motion import, customItems prop for ReactNode items
"use client";
...
function OrbitItem({
  ...
  const width = itemWidth ?? itemSize;
  const height = itemHeight ?? itemSize;
...
export default function OrbitPath({
  ...
  const items: ReactNode[] = customItems?.length
    ? customItems
